sap.ui.define([
    ...
    return BaseController.extend("sap.ui.demo.nav.controller.employee.overview.EmployeeOverviewContent", {
        ...
        _onRouteMatched: function (oEvent) {
            ...
            this._applySorter(oQueryParameter.sortField, oQueryParameter.sortDescending === "true");
        ...
        _initViewSettingsDialog: function () {
            ...
            this._oVSD.addSortItem(new ViewSettingsItem({
                key: "EmployeeID",
                text: "Employee ID",
                selected: true // By default MockData is sorted by EmployeeID
            }));
		 ...
		 * @private
		 */
        _applySorter: function (sSortField, bSortDescending) {
            var _bSortDescending, oBinding, oSorter;

            // only continue if we have a valid sort field
            if (sSortField && this._aValidSortFields.indexOf(sSortField) > -1) {
                // convert the sort order to a boolean value
                if (typeof sortDescending === "string") {
                    _bSortDescending = sortDescending === "true";
                } else if (typeof sortDescending === "boolean") {
                    _bSortDescending = sortDescending;
                } else {
                ...
                // sync with View Settings Dialogs
